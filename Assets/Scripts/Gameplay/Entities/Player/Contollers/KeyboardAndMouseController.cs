...
namespace GameCore
{
    public class KeyboardAndMouseController : PlayerController
    {
        ...
        public override bool PlaceBlockUnderPlayer() => Keyboard.current != null && Keyboard.current.xKey.wasPressedThisFrame;
        public override bool DisablePlatform() => Keyboard.current != null && Keyboard.current.sKey.isPressed;
