...
namespace GameCore.UI
{
    ...
    public class PlayerUI
    {
        ...
        public bool IsInInteractionMode() => !placementModePanel.gameObject.activeSelf;
        public bool IsInPlacementMode() => placementModePanel.gameObject.activeSelf;
        ...
        public PlayerUI(Player player)
        {
            ...
            buildingCenterButton.SetSizeDelta(60, 60);
            ...
            housingRentalPanel.AfterRefreshing += _ =>
            {
                ...
                {
                    //只会寻找当前区域内的房屋
                    if (chunk.regionIndex != player.regionIndex)
                        continue;
    ...
    public sealed class HousingRentalScrollViewPool
    {
        ...
        public ButtonIdentity Get(PlayerUI pui)
        {
            var result = (stack.Count == 0) ? Generation(pui) : stack.Pop();
        ...
        public ButtonIdentity Generation(PlayerUI pui)
        {
            var result = GameUI.AddButton(UIA.Middle, $"ori:button.building_center.housing_rental_item_{Tools.randomInt}", pui.housingRentalScrollView.content);
    ...
    public sealed class HousingRentalNPCScrollViewPool
    {
        ...
        public ButtonIdentity Generation(PlayerUI pui)
        {
            var result = GameUI.AddButton(UIA.Middle, $"ori:button.building_center.housing_rental_npc_item_{Tools.randomInt}", pui.housingRentalNPCScrollView.content);
