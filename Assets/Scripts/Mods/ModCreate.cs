    ...
    public static class ModCreate
    {
        ...
        public static DKDictionary<string, string, string[]> pairs = new()
        {
            pairs = new()
            {
                ...
                {
                    new("data.recipes.crafting.id", "0.6.0"),
                    new[] { "ori:crafting_recipe", "id" }
                },
                {
                    new("data.recipes.crafting.result.id", "0.6.0"),
                    new[] { "ori:crafting_recipe", "result", "id" }
                },
                {
                    new("data.recipes.crafting.result.count", "0.6.0"),
                    new[] { "ori:crafting_recipe", "result", "count" }
                },
                {
                    new("data.recipes.crafting.items", "0.6.0"),
                    new[] { "ori:crafting_recipe", "items" }
                },
                {
                    new("data.recipes.crafting.items.id", "0.6.0"),
                    new[] { "id" }
                },
                {
                    new("data.recipes.crafting.items.count", "0.6.0"),
                    new[] { "count" }
                },
                {
                    new("data.recipes.crafting.items.tags", "0.6.0"),
                    new[] { "tags" }
                },
                ...
                {
                    new("data.recipes.cooking.id", "0.6.0"),
                    new[] { "ori:cooking_recipe", "id" }
                },
                {
                    new("data.recipes.cooking.result.id", "0.6.0"),
                    new[] { "ori:cooking_recipe", "result", "id" }
                },
                {
                    new("data.recipes.cooking.result.count", "0.6.0"),
                    new[] { "ori:cooking_recipe", "result", "count" }
                },
                {
                    new("data.recipes.cooking.items", "0.6.0"),
                    new[] { "ori:cooking_recipe", "items" }
                },
                {
                    new("data.recipes.cooking.items.id", "0.6.0"),
                    new[] { "id" }
                },
                {
                    new("data.recipes.cooking.items.count", "0.6.0"),
                    new[] { "count" }
                },
                {
                    new("data.recipes.cooking.items.tags", "0.6.0"),
                    new[] { "tags" }
                },
